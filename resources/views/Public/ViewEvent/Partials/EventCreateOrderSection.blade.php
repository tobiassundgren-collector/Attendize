                         ...
                         <div class="ticket_holders_details" >
                            ...
                            @foreach($tickets as $ticket)
                                @for($i=0; $i<=$ticket['qty']-1; $i++)
                                 ...
                                 {!! Form::input("ticket_holder_first_name[{$i}][{$ticket['ticket']['id']}]", null, ['required' => 'required', 'class' => "ticket_holder_first_name.$i.{$ticket['ticket']['id']} ticket_holder_first_name form-control"]) !!}
...
Betala med kort via Stripe.com
  ...
  Följ instruktionerna nedan eller scanna QR koden som du hittar på nästa sida.
  
                    <div class="offline_payment_2">
